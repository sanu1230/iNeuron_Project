    ...
    def run(self):
        ...
        def send():
            ...
            if msg != '':
                ...
                timestamp.append(str(c.hour)+":"+str(c.minute)+":"+str(c.second))
...
class ideal(threading.Thread):
    def run(self):
        ...
        while True:
            ...
            if (bot_reply_time + 1 == current_time and bot_reply_time == last_bot_reply_time):
